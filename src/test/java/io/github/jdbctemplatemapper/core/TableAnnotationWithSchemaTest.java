...
public class TableAnnotationWithSchemaTest {
  ...
  public void autoId_crud_withSchema1Annotation() {
    if (!jdbcDriver.contains("mysql")) {
      ...
      CustomerSchema1 customer1 = jtm.findById(CustomerSchema1.class, customer.getCustomerId());
  ...
  public void queryCount_withSchema2Annotation() {
    if (!jdbcDriver.contains("mysql")) {
      ...
      Integer count =
          QueryCount.type(CompanySchema2.class).where("id = ?", company.getId()).execute(jtm);
